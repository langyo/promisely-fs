...
exports.writeFile = exports.readFile = exports.rmdir = exports.unlink = exports.stat = exports.access = exports.symlink = exports.readdir = void 0;
var fs_1 = require("fs");
var util_1 = require("util");
exports.readdir = util_1.promisify(fs_1.readdir);
exports.symlink = util_1.promisify(fs_1.symlink);
exports.access = function (path) { return __awaiter(void 0, void 0, void 0, function () {
    var e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, util_1.promisify(fs_1.access)(path)];
            case 1:
                _a.sent();
...
exports.stat = util_1.promisify(fs_1.stat);
